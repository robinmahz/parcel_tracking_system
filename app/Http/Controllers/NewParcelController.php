...
class NewParcelController extends Controller
{
    ...
    {
        $text = 'Receiver: ' . $newParcel->recipient_details . '. Tracking No: ' . $request->input('tracking_no') . '. Tracking Site: ' . $request->tracking_site . ' Tracking url: ' . $request->input('tracking_url') . ' - Direct Way Cargo';
