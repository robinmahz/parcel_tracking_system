        ...
        <form class="max-w-md mx-auto mb-12" action="/track" method="POST">
            ...
            <div class="flex items-center  py-2">
                <input
                    ...
                    type="text" placeholder="Receivers Name" aria-label="Name" name="name">
                <input
                    class="appearance-none bg-transparent  w-[215px] border-b border-blue-500 text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none rounded"
                ...
                <div class="flex flex-col lg:flex-row items-start lg:space-x-8 gap-8">
                    ...
                    <div class="bg-gray-100 dark:bg-gray-800 px-8 pt-16 rounded-lg shadow-md w-full lg:w-1/2 lg:mb-0">
                        ...
                        <ul class="text-gray-700 dark:text-gray-300 text-left h-[24rem]">
                            ...
                            <li class="mb-2">
                                <strong>Email:</strong> directwaycargooffice@gmail.com
                            </li>
                            <div class="flex gap-6 pl-4">
                                <a href="https://www.facebook.com/directwayexporters" target="blank">
                                ...
                                <a href="https://x.com/DIRECTWAY" target="blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="100"
                                        viewBox="0 0 48 48">
                                        <path fill="#03A9F4"
