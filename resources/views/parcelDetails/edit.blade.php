    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 justify-center flex">
            <div class="bg-white dark:bg-gray-800 mt-4 overflow-hidden shadow-sm sm:rounded-lg w-fit">
                <form class="max-w-sm mx-auto p-8" method="POST" action="/parcelDetails/{{ $parcelDetail->id }}">
                    @csrf
                    @method('Patch')
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="location" name="location"
                            class="shadow-sm w-80  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            required />
                    </div>
                    <div class="mb-5">
